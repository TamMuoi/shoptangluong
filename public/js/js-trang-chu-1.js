...
jQuery(document).ready(function($) {
     ...
     $('.icon-menu').click(function(event) {
        ...
        if($('.submenu').attr('class')=="submenu mn-show"){

            $('.submenu').removeClass('mn-show');
            $('header.font-sfui.home').css({background: 'none'});
            $('header.home ul li a').css({color: '#fff'});
            $('.s-menu').html("menu");
            $('.icon-menu.ic-active').removeClass('ic-active');
          
        }
        else{

            $('.submenu').addClass('mn-show');   
            $('header.home').css({background: '#ffffff'});
            $('header.home ul li a').css({color: '#000000'});
            $('.s-menu').html("CLOSE");
            $('.icon-menu').addClass('ic-active'); 
            
        
        }
         // MENU MOBIE
        if($('.menu-m').attr('class')=="menu-m active"){
        ...
        if ($('.font-sfui.home').attr('class')=="font-sfui home header-m") {
            $('.font-sfui.home.header-m').removeClass('header-m');
        }
        else{
            $('header.home').addClass('header-m');
        }
      ...
      $('.s-menu').click(function(event) {
        ...
        if($('.submenu').attr('class')=="submenu mn-show"){
            ...
            $('header.home ul li a').css({color: '#000'});
      ...
      // $('a.submenu-child-toggle.a-1').click(function(event) {


      //   if($('.ul-submenu-m-wrap').attr('class')=="ul-submenu-m-wrap v-1"){
      //       $('.ul-submenu-m-wrap').removeClass('v-1');
      //       $('.ul-submenu-m-wrap.v-1').hide(300);
      //   }
      //   else{
      //        $('.ul-submenu-m-wrap').addClass('v-1');
      //        $('.ul-submenu-m-wrap.v-1').show(300);
      //   }
       
      //    return false;
      // });
      // 
    //  $('.ul-submenu-m-wrap').slideUp();
      $('.submenu-child-toggle').click(function(event) {

        $('.ul-submenu-m-wrap').slideUp();
        $(this).next().slideToggle();

        // $('ul.ul-submenu-m>li>a>i:first()').html("-");
          return false;
      });

    $('header i.fas.fa-search').click(function(event) {

        if($('.form-control.input-find').attr('class')=="form-control input-find f-active"){
          //  $('.input-find').css({display: 'none'});
          $('.form-control.input-find.f-active').removeClass('f-active');

        }else{
            $('.form-control.input-find').addClass('f-active');
