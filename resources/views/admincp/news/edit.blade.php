    ...
    <div class="row">
        <div class="box-content"  >
            <div class="table-responsive" >
                ...
                <form name="create" action="{{ url('admincp/news/update/'.$news->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <label class="text-body custom-control-label">Tiêu Đề:</label>
                        <input id="name" type="text" class="form-control backgroundinput @error('name') is-invalid @enderror" name="name" value="{{ $news->title }}" required autocomplete="name" autofocus>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="summary" class="form-control" required rows="5">{{ $news->summary }}</textarea>
                    </div>
                    <div class="form-group">
                        <label class="text-body custom-control-label" >Nội Dung:</label>
                        <textarea name="content" class="form-control" required rows="5">{{ $news->content }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div id="imagePreview" style="margin: 0 auto;">
                            <img style="width:300px;" src="{{ asset('images/news/'.$news->image) }}"/>
                        </div>
